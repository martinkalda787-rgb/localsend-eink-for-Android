...
import 'package:localsend_app/widget/custom_icon.dart';
          ...
          return Scaffold(
            ...
            bottomNavigationBar: sizingInformation.isMobile
                ? Container(
                    height: 60,
                    decoration: BoxDecoration(
                      border: Border(top: BorderSide(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.2), width: 1.5)),
